      ...
      <div className="container mx-auto">
        <div className="glass rounded-2xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
            ...
            <a href="#download" className="hover:text-white transition-colors text-emerald-400 font-semibold">Tải về</a>
          ...
          <div className="flex items-center gap-3">
            <a
              href="#download"
              className="text-xs sm:text-sm font-semibold px-4 py-2 rounded-lg bg-white text-black hover:bg-gray-200 transition-all shadow-[0_0_15px_rgba(255,255,255,0.2)]"
            >
              Tải miễn phí
            </a>
            <a
              ...
              className="hidden sm:inline-block text-sm font-semibold px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors"
            >
              GitHub
            </a>
          </div>
